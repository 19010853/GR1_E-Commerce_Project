...
router.post('/product-add-image', authMiddleware, productController.add_product_image)
router.post('/product-remove-image', authMiddleware, productController.remove_product_image)
