          ...
          <div className="grid grid-cols-2 md-lg:grid-cols-1 gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="text-slate-600">
                <p className="text-slate-600 py-1 font-bold">Mô tả sản phẩm:</p>
                <p>{product.description}</p>
              </div>
              <div className="flex bg-slate-200 h-[50px] justify-center items-center text-xl">
                <button
                  onClick={dec}
                  className="px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#890528] text-white"
                >
                  -
                </button>
                <span className="px-8 py-3 h-[50px]">{quantity}</span>
                <button
                  onClick={inc}
                  className="px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#890528] text-white"
                >
              ...
              <div className="flex py-5 gap-5">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  >
                    {product.stock ? `Còn hàng (${product.stock})` : "Hết hàng"}
                  </span>
              ...
              <div className="pr-4 md-lg:pr-0">
                <div className="grid grid-cols-2">
                  <button
                    ...
                    className={`py-1 hover:text-white px-5 hover:bg-[#890528] ${
                      state === "reviews"
                        ? "bg-[#890528] text-white"
            ...
            <div className="w-[28%] md-lg:w-full">
              <div className="pl-4 md-lg:pl-0">
                <div className="px-3 py-2 text-slate-600 bg-slate-200">
                  <h2 className="font-bold">Từ {product.shopName}</h2>
                </div>
